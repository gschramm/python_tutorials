...
#t = np.linspace(1e-3, 8, 1000)
t = torch.linspace(1e-3, 8, 1000, dtype=torch.float64)
...
ax[0, 1].plot(t,
              C_PET1_high(t) / C_PET1_low(t),
              'k:',
              label='C_PET1(t) / C_PET2(t)')

ax[0,
   2].plot(t,
           C_t1_high.indefinite_integral(t) - C_t1_high.indefinite_integral(0),
           'r',
           label=r'$\int_0^t$ C_t1($\tau$) d$\tau$')
ax[0,
   2].plot(t,
           C_t1_low.indefinite_integral(t) - C_t1_low.indefinite_integral(0),
           'b',
           label=r'$\int_0^t$ C_t2($\tau$) d$\tau$')
ax[0, 2].plot(t,
              C_PET1_high.indefinite_integral(t) -
              C_PET1_high.indefinite_integral(0),
              'r:',
              label=r'$\int_0^t$ C_PET1($\tau$) d$\tau$')
ax[0, 2].plot(t,
              C_PET1_low.indefinite_integral(t) -
              C_PET1_low.indefinite_integral(0),
              'b:',
              label=r'$\int_0^t$ C_PET2($\tau$) d$\tau$')

ax[0, 3].plot(
    t, (C_t1_high.indefinite_integral(t) - C_t1_high.indefinite_integral(0)) /
    (C_t1_low.indefinite_integral(t) - C_t1_low.indefinite_integral(0)),
    'k',
    label=r'$\int_0^t$ C_t1($\tau$) d$\tau$ / $\int_0^t$ C_t2($\tau$) d$\tau$')
ax[0, 3].plot(
    t,
    (C_PET1_high.indefinite_integral(t) - C_PET1_high.indefinite_integral(0)) /
    (C_PET1_low.indefinite_integral(t) - C_PET1_low.indefinite_integral(0)),
    'k:',
    label=
    r'$\int_0^t$ C_PET1($\tau$) d$\tau$ / $\int_0^t$ C_PET2($\tau$) d$\tau$')
...
ax[1,
   2].plot(t,
           C_t2_high.indefinite_integral(t) - C_t2_high.indefinite_integral(0),
           'r')
ax[1,
   2].plot(t,
           C_t2_low.indefinite_integral(t) - C_t2_low.indefinite_integral(0),
           'b')
ax[1, 2].plot(
    t,
    C_PET2_high.indefinite_integral(t) - C_PET2_high.indefinite_integral(0),
    'r:')
ax[1, 2].plot(
    t,
    C_PET2_low.indefinite_integral(t) - C_PET2_low.indefinite_integral(0),
    'b:')

ax[1, 3].plot(
    t, (C_t2_high.indefinite_integral(t) - C_t2_high.indefinite_integral(0)) /
...
ax[2,
   2].plot(t,
           C_t3_high.indefinite_integral(t) - C_t3_high.indefinite_integral(0),
           'r')
ax[2,
   2].plot(t,
           C_t3_low.indefinite_integral(t) - C_t3_low.indefinite_integral(0),
           'b')
ax[2, 2].plot(
    t,
    C_PET3_high.indefinite_integral(t) - C_PET3_high.indefinite_integral(0),
    'r:')
ax[2, 2].plot(
    t,
    C_PET3_low.indefinite_integral(t) - C_PET3_low.indefinite_integral(0),
    'b:')

ax[2, 3].plot(
    t, (C_t3_high.indefinite_integral(t) - C_t3_high.indefinite_integral(0)) /
