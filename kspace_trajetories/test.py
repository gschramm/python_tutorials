...
if __name__ == '__main__':
    ...
    recon_mse = [mse(recon, signal.signal(x)) for recon in pdhg_recons]
    recon_mae = [mae(recon, signal.signal(x)) for recon in pdhg_recons]

    print("global MSE", recon_mse)
    print("global MAE", recon_mae)
